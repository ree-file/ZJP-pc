...
return [
	...
	// 合约分级配置
	'CONTRACT_LEVEL_ONE' => '1000', // 一级合约蛋数
	'CONTRACT_LEVEL_TWO' => '2000', // 二级合约蛋数
	'CONTRACT_LEVEL_THREE' => '3000', // 三级合约蛋数
	'CONTRACT_LEVEL_FOUR' => '4000', // 四级合约蛋数
	'CONTRACT_LEVEL_FIVE' => '6000', // 五级合约蛋数
	// 猫窝分红配置
	'BONUS_ONE_RATE' => '0.10', // 上一级分红金额比率
	'BONUS_TWO_RATE' => '0.03', // 上二级分红金额比率
	'BONUS_THREE_RATE' => '0.05', // 上三级分红金额比率
	// 充值配置
